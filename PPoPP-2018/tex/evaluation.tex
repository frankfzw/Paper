...
It is because that those queries contain shuffle intensive operations such as "groupby", "union", etc.
...
So the cost of pre-scheduling algorithm and memory management are unlikely to make the master become the bottleneck of the whole system.
}

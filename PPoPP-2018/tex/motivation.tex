...
\hlyellow{
Shuffle write starts at the end of a map task writing the partitioned map output data to local persistent storage. 
Shuffle read starts at the beginning of a reduce task fetching the partitioned data from remote as its input. 
}

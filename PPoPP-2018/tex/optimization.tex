...
The $m$ is the number of map tasks and can be easily extracted from DAG information. 
...
\marginpar{B2,D6,D8}
\fi
For most of the DAG applications with random large scale input, 
...
and applies the longest processing time rule (LPT)} \cite{design}\hlyellow{ to achieve $4/3\text{-}approximation$ optimum. }
\hlyellow{

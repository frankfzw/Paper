...
In this paper, we answer this question in the affirmative with S(huffle)Cache, a plug-in system which provides a shuffle-specific optimization for different DAG computing frameworks.

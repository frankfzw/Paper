...
To address the challenges, we propose a heuristic reduce tasks pre-scheduling scheme with shuffle data predict and a tasks co-scheduler} (Section \ref{opt}).

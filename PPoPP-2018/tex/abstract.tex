...
To reduce shuffle overhead, we present \textit{SCache}, an open source \footnote{https://github.com/frankfzw/SCache} plug-in system that particularly focuses on shuffle optimization. 

...
\hlyellow{
Currently, we left the sever fault such as the failure of a node to the DAG frameworks. 
We believe it is a more promising way because most DAG frameworks have more advanced fast recovery schemes on application layer, such as paralleled recovery of Spark. 
